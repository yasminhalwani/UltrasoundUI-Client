...
# To use within your code: copy and paste PlotWindow and dataSendLoop() into the main class
# the main class should have a global variable to be used by dataSendLoop (the global variable's value to be emitted)
# call PlotWindow(ylim) wherever needed in your main class
...
def dataSendLoop(addData_callbackFunc):
    ...
    while True:
        ...
        # mySrc.data_signal.emit(time.time())
        i += 1
        ###
